...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ScopedModelDescendant<MovieModalImpl>(
        builder: (BuildContext context, Widget? child, MovieModalImpl model) {
          return Container(
